...
import { Check, ChevronLeft, Download, LogOut, Pencil, Search, Tag, Trash2 } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
              ...
              <div className="divide-y divide-gray-100 max-h-[70vh] overflow-y-auto">
                {filtered.length === 0 ? (
                  <div className="p-6 text-sm text-gray-500">No saved leads yet. Save a Business Lead to your CRM to start tracking outreach.</div>
                ) : (
                  filtered.map((l) => (
                    <button
                      key={l.id}
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <div className="font-bold text-gray-900">{l.business?.name}</div>
                          <div className="text-xs text-gray-500 mt-0.5">
                            {l.business?.industry} • {l.business?.location}
                          </div>
                        ...
                        <div className="text-right text-[10px] text-gray-400 uppercase font-bold">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
              ...
              {!selected ? (
                ...
                <div className="p-5 space-y-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="text-lg font-bold">{selected.business?.name}</div>
                      <div className="text-sm text-gray-600">
                        {selected.business?.industry} • {selected.business?.location}
                      </div>
